...
uniform sampler2D unif_opacity_mask_sampler;
...
void main()
{
    ...
    float object_opacity = texture(unif_opacity_mask_sampler, frag_uv).r;
    ...
    FragColor = vec4(final_color, unif_opacity * object_opacity);
}